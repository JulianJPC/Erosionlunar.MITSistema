...
namespace Erosionlunar.MITSistema.VisspoolControl
{
    public class VisspoolControl
    {
        ...
        public string Visspool(string pathAlArchivo, ArchivosModel unArchivo, Regex elRegex, string nombreLibro)
        {
            ...
            string pathArchivoPrincipal = Path.Combine(dirInical, nombreLibroCorto + mes + year + "P" + unArchivo.Fraccion + ".MDB");
